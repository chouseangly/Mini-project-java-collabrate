...
public class ProductView {
    ...
    public void displayAllProductsAndMenu(List<ProductDao> products, ProductController controller) {
...
//                        controller.handleBackup();
    ...
    public ProductDao getInputForNewProduct(int generateNewId) {
        ...
        return new ProductDao(name, unitPrice, stockQty);
    }
    ...
    public void displayProducts(List<ProductDao> products) {
        if (products == null || products.isEmpty()) {
    ...
    private void handleUpdateMenu(ProductController controller) throws SQLException {
        ...
        ProductDao product = controller.displayUpdateProductTable(productId);
    ...
    public void handleGetProductById(ProductController controller) throws SQLException {
        ...
        ProductDao product = controller.fetchProductById();
        if (product == null) {
            System.out.println(c.RED + "Product not found!" + c.RESET);
            return;
        }
    ...
    public void handleDeleteProductById(ProductController controller) throws SQLException {
        ...
        ProductDao product = controller.displayDeleteProductById(productId);
    ...
    public void displayProductsByName(List<ProductDao> products) {
        if (products == null || products.isEmpty()) {
            System.out.println(c.RED + "No products available!" + c.RESET);
    ...
    private void
    handleSetRowLimit(ProductController controller) {
